...
% Título
%-----------------------------------------------------------------------------------
\title{Informe del Proyecto de Ecuaciones Diferenciales Ordinarias y Matemática Numérica}
...
%-----------------------------------------------------------------------------------
\tutors{\\
Dr. Damian Valdés Santiago, \emph{Facultad de Matemática y Computación} \\
Lic. Ania Mesa, \emph{Facultad de Matemática y Computación}}
...
Mostremos el plano de Fase de el sistema planteado:
